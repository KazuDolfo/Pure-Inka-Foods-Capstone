...
('Bernardo Adolfo', 'berna@gmail.com', '$2b$12$aG2Q32bKrysmubvJc9LKqOftMa3oYnY.q.D53TNOZ00.1Oowxa/Y6', 'CLIENTE', '979380273', '2026-04-16 17:58:34'),
('Administrador', 'admin@pureinka.com', '$2b$12$bPkYWAzKZ6C3bzEPpIxZA.MhZJFRR/ovccrMiBFtCNXxBvdlP9rJq', 'ADMIN', '987654321', '2026-04-16 18:01:42'),
...
(1, 'MOR-001', 'Moringa Powder', '100% Pure Andes Superfood. Alto contenido de antioxidantes.', 38.00, 50, 'product-1780269949185.webp', TRUE),
(1, 'CAM-002', 'Camu Camu Powder', 'Súper alimento amazónico con la mayor concentración de Vitamina C.', 45.00, 40, 'product-1780269959597.webp', TRUE),
(1, 'GIN-003', 'Ginger Powder', 'Jengibre premium deshidratado, ideal para el sistema inmunológico.', 22.00, 60, 'product-1780269967599.webp', TRUE),
(1, 'MAC-004', 'Maca Powder', 'Energizante natural andino para vitalidad y equilibrio.', 32.50, 100, 'product-1780269975233.webp', TRUE),
(1, 'PUR-005', 'Purple Corn Powder', 'Maíz morado orgánico rico en antocianinas.', 25.90, 85, 'product-1780269981483.webp', TRUE),
(2, 'CAC-006', 'Cacao Nibs', 'Nibs de cacao puro sin azúcar. Energía natural.', 29.90, 55, 'product-1780269990416.webp', TRUE),
(2, 'CHI-007', 'Chia Seeds', 'Semillas de chía ricas en Omega-3 y fibra.', 19.50, 75, 'product-1780269997962.webp', TRUE),
(2, 'QUI-008', 'Quinoa Grain', 'Quinua real en grano, fuente completa de proteínas.', 18.00, 120, 'product-1780270006148.webp', TRUE),
(3, 'CAY-009', 'Cacay Oil', 'Aceite de Cacay 100% puro para el cuidado de la piel.', 95.00, 20, 'product-1780270015866.webp', TRUE),
(3, 'SAC-010', 'Sacha Inchi Oil', 'Aceite de Sacha Inchi extra virgen, el Omega vegetal más potente.', 58.00, 30, 'product-1780270021777.webp', TRUE),
(6, 'STE-011', 'Stevia Powder', 'Extracto de estevia pura en polvo sin calorías.', 24.50, 60, 'product-1780270027312.webp', TRUE),
(6, 'YAC-012', 'Yacon Syrup', 'Jarabe de Yacón orgánico. Endulzante prebiótico natural.', 48.00, 35, 'product-1780270032693.webp', TRUE);
